...
This document lists all files in the project structure along with their content.
...
### env/custom_env/run.json
```json
{
  "pre": [{
    "env": "CUSTOM_ENV",
    "description": "Set the CUSTOM_ENV environment variable",
...
module.exports = {
  "run": [{
    ...
    "params": {
      "uri": "https://raw.githubusercontent.com/pinokiocomputer/test/main/update.json",
      "dir": "https://github.com/pinokiocomputer/test.git/path"
    }
  }]
}
```

### fs/fs_download_git.js
```javascript
module.exports = {
  "run": [{
    "method": "fs.download",
    "params": {
      "uri": "https://jsonplaceholder.typicode.com/todos",
      "path": "https://github.com/pinokiocomputer/test.git/path/todos2.json",
    }
  }]
}
```
...
### loop/loop_until_condition.json
```json
{
  "run": [{
    "method": "local.set",
...
### multi-install/handle_stop.json
```json
{
  "daemon": true,
  "run": [{
...
```json
{
  "run": [{
    ...
    "method": "script.run",
    "params": {
      "uri": "https://github.com/cocktailpeanutlabs/automatic1111.git/install.js"
    }
  }, {
    "method": "log",
    "params": {
...
### multi-install/run_and_stop.json
```json
{
  "run": [{
    "method": "script.start",
...
<a class='btn' href='https://github.com/pinokiocomputer/pinokio/releases/download/3.4.0/Pinokio-3.4.0-win32.zip'><i class="fa-brands fa-windows"></i> Download for Windows</a>
...
<a class='btn' href='https://github.com/pinokiocomputer/pinokio/releases/download/3.4.0/Pinokio-3.4.0-darwin-arm64.zip'><i class="fa-brands fa-apple"></i> Download for Apple Silicon Mac (M1/M2/M3/M4)</a>&nbsp;&nbsp;<a class='btn' href='https://github.com/pinokiocomputer/pinokio/releases/download/3.4.0/Pinokio-3.4.0-darwin-intel.zip'><i class="fa-brands fa-apple"></i> Download for Intel Mac</a>
...
<a class='btn' href='https://github.com/pinokiocomputer/pinokio/releases/tag/3.4.0'><i class="fa-brands fa-linux"></i> Go to the Releases Page</a>
